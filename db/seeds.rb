...
sofa = Ad.create(user: User.find_by(email: 'ringo@mail.com'), name: 'Super canapé', department: 'Meuble', description: 'Canapé en velour bleu. Très peu utilisé!', price: 300)
...
design_lamp= Ad.create(user: User.find_by(email: 'ringo@mail.com'), name: 'Lampe design', department: 'Décoration', description: 'Belle lampe, très design', price: 90)
...
storage_cabinet = Ad.create(user: User.find_by(email: 'ringo@mail.com'), name: 'Meuble Kallax Ikéa', department: 'Meuble', description: 'Meuble de rangement très pratique', price: 30)
